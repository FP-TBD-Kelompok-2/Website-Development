    ...
    <div class="grid grid-cols-3 px-24 ">
        ...
        <div class="lg:pt-8">
            ...
            <form action="/product/process" method="post">
                ...
                <input type="hidden" name="device_brand" value="{{$product['device_brand']}}">
                <input type="hidden" name="device_storage" value="{{$product['device_storage']}}">
                <input type="hidden" name="device_connectivity" value="{{$product['device_connectivity']}}">
